...
class FunctionsApiClient {
    ...
    updateTaskPayload(task, resources, extensionId) {
        return __awaiter(this, void 0, void 0, function* () {
            const functionUrl = validator.isNonEmptyString(task.httpRequest.url)
                ? task.httpRequest.url
                : yield this.getUrl(resources, FIREBASE_FUNCTION_URL_FORMAT);
            ...
            if (validator.isNonEmptyString(extensionId) && this.app.options.credential instanceof credential_internal_1.ComputeEngineCredential) {
                const idToken = yield this.app.options.credential.getIDToken(functionUrl);
                task.httpRequest.headers = Object.assign(Object.assign({}, task.httpRequest.headers), { 'Authorization': `Bearer ${idToken}` });
                ...
                const account = yield this.getServiceAccount();
