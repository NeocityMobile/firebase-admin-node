...
class EventarcApiClient {
    ...
    publish(events) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return this.publishToEventarcApi(yield this.resolvedChannelName, events
    ...
    publishToEventarcApi(channel, events) {
        return __awaiter(this, void 0, void 0, function* () {
            if (events.length === 0) {
                return;
            }
    ...
    resolveChannelNameProjectId(location, channelId) {
        return __awaiter(this, void 0, void 0, function* () {
