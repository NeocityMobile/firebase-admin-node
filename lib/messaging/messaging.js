    ...
    sendToDevice(registrationTokenOrTokens, payload, options = {}) {
        ...
        return Promise.resolve()
            ...
            if ('multicast_id' in response) {
                ...
                return Object.assign(Object.assign({}, groupResponse), { canonicalRegistrationTokenCount: -1, multicastId: -1, results: [] });
            }
        });
    }
    /**
        ...
        return Promise.resolve()
            ...
            if ('multicast_id' in response) {
                if (response.success === 0) {
                    ...
                    return Object.assign(Object.assign({}, devicesResponse), { failedRegistrationTokens: [] });
                }
            }
