...
function isGcsTfliteModelOptions(options) {
    var _a;
    const gcsUri = (_a = options === null || options === void 0 ? void 0 : options.tfliteModel) === null || _a === void 0 ? void 0 : _a.gcsTfliteUri;
...
class MachineLearningApiClient {
    ...
    pollOperationWithExponentialBackoff(opName, options) {
        var _a, _b, _c;
        const maxTimeMilliseconds = (_a = options === null || options === void 0 ? void 0 : options.maxTimeMillis) !== null && _a !== void 0 ? _a : POLL_DEFAULT_MAX_TIME_MILLISECONDS;
        const baseWaitMillis = (_b = options === null || options === void 0 ? void 0 : options.baseWaitMillis) !== null && _b !== void 0 ? _b : POLL_BASE_WAIT_TIME_MILLISECONDS;
        const maxWaitMillis = (_c = options === null || options === void 0 ? void 0 : options.maxWaitMillis) !== null && _c !== void 0 ? _c : POLL_MAX_WAIT_TIME_MILLISECONDS;
